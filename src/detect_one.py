...
def parse_args():
    ...
    parser.add_argument('--prototxt', type=str, default='/home/chli/chLi/Download/DeepLearning/Model/yolov3/waterDrop_new/yolov3.prototxt')
    parser.add_argument('--caffemodel', type=str, default='/home/chli/chLi/Download/DeepLearning/Model/yolov3/waterDrop_new/yolov3_train_waterDrop_2class.caffemodel')
    parser.add_argument('--classfile', type=str, default='/home/chli/chLi/Download/DeepLearning/Model/yolov3/waterDrop_new/coco.names')
    parser.add_argument('--image', type=str, default='/home/chli/public/20201222164429.jpg')
...
def main():
    ...
    scaling_factor = min(1, 1.0 * args.resolution / img_ori.shape[1])
